...
And here another method (\Cref{tikzlist}) for mixing (overlay) a picture with a listing of code. \textcolor{violet}{Please note that the caption is located at the bottom of the image, as indicated by the option "captionpos=b" in the command invoking the listing.}
% #############################################################################
...
\Cref{fig:ui_playout,fig:ui_loading}\todo[color=cyan!40, author=RC, fancyline]{A figure with Subfigs} proin at eros non eros adipiscing mollis.
...
\begin{figure}[htbp]
	...
	\caption{Complete User Interface. a) Loading window. b) Player}
