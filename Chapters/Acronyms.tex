...
% !TEX root = ../main.tex
% #############################################################################
% You can create your own acronyms and abbreviations here, replacing this list
...
\begin{acronym}[H.264/SVC]
	...
	\acro{EJU}{EuroHPC Joint Undertaking}
	\acrodefplural{EJU}{EuroHPC Joint Undertakings}
	\acro{DARE}{Digital Autonomy with RISC-V in Europe}
	\acro{IIT}{Indian Institutes of Technology}
	\acrodefplural{IIT}{Indian Institutes of Technology}
	\acro{ETHZ}{Eidgenössische Technische Hochschule Zürich}
	\acro{MIT}{Massachusetts Institute of Technology}
	\acro{ARM}{Advanced RISC Machines}
	\acro{FP}{Floating Point}
	\acro{RISC-V}{Reduced Instruction Set Computer V}
	\acrodefplural{RISC-V}{Reduced Instruction Set Computer Vs}
	\acro{ISA}{Instruction Set Architecture}
	\acrodefplural{ISA}{Instruction Set Architectures}
	\acro{HDL}{Hardware Description Language}
	\acrodefplural{HDL}{Hardware Description Languages}
	\acro{FPGA}{Field Programmable Gate Array}
	\acrodefplural{FPGA}{Field Programmable Gate Arrays}
	\acro{CPI}{Cycles per Instruction}
	\acro{IO}{Input/Output}
	\acrodefplural{IO}{Inputs/Outputs}
	\acro{hart}{Hardware Thread}
