...
%
% -----------------------------------------------------------------------------
% PACKAGES fontspec, babel, iflang:
% -----------------------------------------------------------------------------
\usepackage{fontspec}
...
\usepackage{iflang}
%
% Change the default Table of Contents name in Portuguese:
...
%Bytefield helps creating instruction visualizations
...
% -----------------------------------------------------------------------------
% Is required if you need to describe an algorithm or a pseudocode.
...
%\usepackage[textwidth=1.85cm, textsize=small]{todonotes}
...
% Note: "portuguese" is supported through "brazilian" option of this package
...
\fancyhf{}
% -----------------------------------------------------------------------------#
% Choose the positioning of the Page Number commenting/Uncommenting the lines:
% Only on the Center side [C]
\fancyfoot[C]{\bfseries\thepage}
% Only on the Right side [R]
%\fancyfoot[R]{\bfseries\thepage}
% In case of Double sided printing, numbers are printed 
% on Left (even pages) and on Right (odd pages)
...
\usepackage[automake,symbols,nopostdot]{glossaries-extra}
